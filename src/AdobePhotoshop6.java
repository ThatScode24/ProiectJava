...
public class AdobePhotoshop6 extends Licenta {
    ...
    public String genereazaCod() {
        while (true) {
            ...
            if (!isBlacklistedPattern(rawCode) && !Blacklist.contains(rawCode) && valideazaCod(rawCode)) { return formatCode(rawCode); }  // verificam ca licenta nu e in blacklist
            // si ca este valid
        }
    }
